    ...
    <section className="font-roboto mt-2 pt-10  container  mx-auto" id="about">
      <div className="">
        <div className="grid md:grid-cols-2 justify-center items-center ">
          <div className="h-[500px] rounded-sm overflow-hidden hidden md:block md:h-[400px]  md:w-[400px]  lg:w-[500px]">
            <img
          ...
          <div className="flex flex-col p-2 text-center md:text-start justify-center">
            <motion.h2
            ...
            <div className="mt-8 p-5">
              <div className="flex  flex-col md:flex-row items-center">
                ...
                <div className=" ml-0 md:ml-5 pt-5 md:pt-0">
                  <Stacks />
                </div>
              </div>
            </div>
