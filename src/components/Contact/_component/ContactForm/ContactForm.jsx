          ...
          <div class="col-span-full">
            ...
            <div class="flex max-lg:flex-col lg:space-x-6 max-lg:space-y-6">
              <div class="flex items-center mt-3">
                ...
                >
                  <span class="border-[4px] border-[#ff4800ab] rounded-full w-full h-full"></span>
                </label>
                <p class="text-sm  dark:text-gray-200  ml-3">General Inquiry</p>
              </div>
              <div class="flex items-center mt-3">
                <input
                  id="radio2"
                ...
                <p class="text-sm dark:text-gray-200 ml-3">web developmet</p>
              </div>
              <div class="flex items-center mt-3">
                <input
                  id="radio3"
                ...
                <p class="text-sm dark:text-gray-200 ml-3">ui/ux designs</p>
              </div>
            </div>
          </div>
        </div>
