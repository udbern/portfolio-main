...
function Footer() {
  return (
    <>
      <footer class="dark:bg-[black] bg-white text-white py-5 px-2 font-sans">
        <div class="text-center">
          <h6 class="text-base capitalize">Stay connected</h6>

          <ul class="flex flex-wrap justify-center gap-x-8 gap-4 my-4">
            <li>
          ...
          <p class="text-base">
            ...
            <a href="" target="_blank" class="mx-2 capitalize">
              uduakabsi bernard edwin
            </a>
            All Rights Reserved.
          </p>
        </div>
